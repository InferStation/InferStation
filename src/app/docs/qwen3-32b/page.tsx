...
export default function Doc() {
  ...
  weightsBF16={{repo:"Qwen/Qwen3-32B", note:"Used by vLLM. Download from the public model repository before running the benchmark."}}
  quants={[
...
python3 scripts/bench-batch.py \\
  --filter='<host-profile>:qwen3-32b:<quantization>' \\
  --scope=all --dry-run
