      ...
      <section id="billing" className="mb-12 scroll-mt-20">
        ...
        <div className="bg-white rounded-lg border p-6 space-y-3 text-sm text-gray-700 leading-relaxed">
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li>{t({ en: "Unit prices are set by providers when registering a backend. The unit is \"currency / 1M tokens\", split into input and output. Currencies: CNY / USD.", zh: "单价由提供者在注册后端时设定，单位为「货币 / 百万 token」，分输入与输出两档；货币支持 CNY / USD" })}</li>
        ...
        <div className="bg-white rounded-lg border overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
              ...
              <tr><td className="px-4 py-2"><code className="text-green-600">GET</code></td><td className="px-4 py-2 font-mono text-xs">/api/models/&#123;model_id&#125;</td><td className="px-4 py-2 text-gray-600">{t({ en: "Get model details", zh: "获取模型详情" })}</td></tr>
              ...
              <tr><td className="px-4 py-2"><code className="text-red-600">DELETE</code></td><td className="px-4 py-2 font-mono text-xs">/api/backends/&#123;name&#125;</td><td className="px-4 py-2 text-gray-600">{t({ en: "Delete a backend", zh: "删除后端" })}</td></tr>
